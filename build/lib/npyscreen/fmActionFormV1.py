...
class ActionFormV1(fmForm.Form):
    ...
    def set_up_exit_condition_handlers(self):
        super(ActionFormV1, self).set_up_exit_condition_handlers()
    ...
    def move_ok_button(self):
        super(ActionFormV1, self).move_ok_button()
...
class ActionFormExpandedV1(ActionFormV1):
    BLANK_LINES_BASE   = 1
